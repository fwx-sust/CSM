...
%exact solution————以下是最简单的四边固支的位移————手输，画图时要用
%位移理论值
...
%手动输入，————bc中哪个是1就改哪个，其余的不注释也可以，dof==1是x方向，dof==2是y方向
